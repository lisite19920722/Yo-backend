...
import tiger.web.api.form.account.SocialAuthForm;
import tiger.web.api.form.account.SocialBindForm;
 ...
 */
@RestController
@RequestMapping(APIConstants.BASE_API_URL + "/social")
@ResponseBody
