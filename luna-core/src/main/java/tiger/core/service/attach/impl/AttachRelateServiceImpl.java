...
import tiger.common.dal.persistence.attach.AttachRelateDO;
import tiger.common.dal.persistence.attach.example.AttachRelateExample;
...
import tiger.core.domain.attach.convert.AttachRelateConvert;
...
public class AttachRelateServiceImpl implements AttachRelateService {
    ...
    @Autowired
    private QiniuAttachService attachService;
